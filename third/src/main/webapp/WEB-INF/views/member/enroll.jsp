...
<tr><td>우편번호</td><td><input type="text" name="address1" size="10"></td></tr>
<tr><td>기본주소</td><td><input type="text" name="address2"></td></tr>
<tr><td>상세주소</td><td><input type="text" name="address3"></td></tr>
